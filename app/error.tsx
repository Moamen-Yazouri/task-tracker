...
const Error = (props: IProps) => {
    return (
        <div className='flex items-center justify-center h-[100vh] w-[100%] bg-gradient-to-b from-teal-300 to-teal-400 flex-col text-white gap-[20px]'>
            ...
            <div>Do you want to <button onClick={() => window.location.reload()} className='underline cursor-pointer hover:scale-[1.06] transition-[3] text-black'>Try again</button></div>
        </div>
    )
}
